...
```bash
# 1. 하네스 레포 루트 (이 CLAUDE.md가 있는 곳)
HARNESS_DIR="$(git -C "$(dirname "$0")" rev-parse --show-toplevel 2>/dev/null || echo /Users/kimkyungpyo/Workspaces/projests/unreal-harness)"
